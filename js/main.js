...
function initializeSortable() {
    ...
    new Sortable(dashboard, {
        ...
        onMove: function(evt) {
            const targetCard = evt.to;
            const isTargetLocked = targetCard.classList.contains('locked');
...
function updateChartData() {
    const period = document.querySelector('.btn-group .btn.active').dataset.period;
    ...
    fetch(`api/get_data.php?period=${period}`)
        ...
        .catch(error => console.error('Erro ao atualizar dados do gráfico:', error));
}
